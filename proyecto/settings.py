...
SECRET_KEY = 'django-insecure-!i^c=o%roc*3t2$$#i878!*kaybv0n0z(9zmh8k3ao5edg0#^m'
...
PWA_APP_NAME = 'Datos Personales'
PWA_APP_SHORT_NAME = 'Datos Pwa'
PWA_APP_DESCRIPTION = 'Aplicación para mostrar datos personales'
PWA_APP_THEME_COLOR = '#007bff'
PWA_APP_BACKGROUND_COLOR = '#6699f7'
PWA_APP_ICONS = [
    {
        'src': "/static/icono/image.png",
        'sizes': '192x192'
    }
]
